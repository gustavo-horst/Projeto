...
public class UsuarioDAOImpl implements UsuarioDAO {
	...
	public void editarUsuario(Usuario usuario) {
		...
		String sql = "UPDATE usuario SET nome_usuario = ?, sobrenome_usuario = ?, Apelido_usuario = ?, email_usuario = ?, senha_usuario = ?, WHERE id = ?";
	...
	@Override
	public Usuario validarConexao(String email, String senha) {
	Usuario usuario = null;
	ResultSet  rs = null;
	PreparedStatement stmt = null;
